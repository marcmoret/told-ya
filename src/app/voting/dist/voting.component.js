...
exports.VotingComponent = void 0;
var core_1 = require("@angular/core");
var chart_js_1 = require("chart.js");
var VotingComponent = /** @class */ (function () {
    function VotingComponent(route, db, argumentService) {
        this.route = route;
        this.db = db;
    ...
    VotingComponent.prototype.setArgument = function (id) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.argumentService.getArgument(this.docId).then(function (argument) {
                                _this.argument = argument.data();
    ...
    VotingComponent.prototype.initChart = function () {
