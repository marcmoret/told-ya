...
var ArgumentService = /** @class */ (function () {
    ...
    ArgumentService.prototype.castVote = function (voterId, voteTotal, docId, person) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                voter = "voter" + voterId;
                votes = "votes" + person;
                return [2 /*return*/, this.db.doc(collection + "/" + docId).update((_a = {},
                        _a[voter] = true,
                        _a[votes] = voteTotal,
                        _a))];
            });
    ...
    ArgumentService.prototype.verifyVoter = function (id, voterId) {
        return __awaiter(this, void 0, void 0, function () {
            var result, docRef;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        docRef = this.db.doc(collection + "/" + id).get();
                        return [4 /*yield*/, docRef.toPromise().then(function (documentSnap) {
